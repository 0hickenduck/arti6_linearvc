...
<head>
    ...
    <title>Voice Conversion Research Dashboard</title>
...
<body>
    ...
    <header>
        <div class="logo-section">
            ...
            <p>Research and Development Comparative Demo Interface</p>
        </div>
        <div class="header-actions">
            <div class="meeting-badge">
                <span class="pulse-dot"></span>
                Research Demo: Voice Conversion
            </div>
            <a href="voice_conversion.zip" class="download-btn" download>
    ...
    <main>
        ...
        <div id="seedvc" class="tab-content">
            ...
            <div class="demo-section-header">
                <h3>Cross-Lingual Singing Pivot (30-step flow matching)</h3>
                <p>Translating an English Alto singer's voice to a Japanese Tenor speaker reference. Cross-lingual voice adaptation.</p>
            </div>
            ...
            <div class="vc-row">
                <div class="row-header">
                    ...
                    <span class="pill-badge">Cross-Lingual Pivot</span>
                </div>
                <div class="card-row-grid">
                    ...
                    <div class="audio-card">
                        ...
                        <div class="card-title-area">
                            <h4>Source Singing</h4>
                            <p>Original English Alto singing vocals.</p>
                        </div>
                        <div class="player-interface">
                            <div class="custom-player">
                                <button class="play-btn" onclick="togglePlay('audio-seed-1')">
                                    <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                                </button>
                                <div class="time-slider-container">
                                    <span class="time-display">0:00</span>
                            ...
                            <audio id="audio-seed-1" src="audio/seedvc_cross_source.wav"></audio>
                        </div>
                    </div>
                    ...
                    <div class="audio-card">
                        ...
                        <div class="card-title-area">
                            <h4>Target Speech Reference</h4>
                            <p>Japanese Tenor speaking voice reference.</p>
                        </div>
                        <div class="player-interface">
                            <div class="custom-player">
                                <button class="play-btn" onclick="togglePlay('audio-seed-2')">
                                    <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                                </button>
                                <div class="time-slider-container">
                                    <span class="time-display">0:00</span>
                            ...
                            <audio id="audio-seed-2" src="audio/seedvc_cross_target.wav"></audio>
                        </div>
                    </div>
                    ...
                    <div class="audio-card">
                        ...
                        <div class="card-title-area">
                            <h4>Pivoted Singing Output</h4>
                            <p>English Alto singing converted to Japanese Tenor.</p>
                        </div>
                        <div class="player-interface">
                            <div class="custom-player">
                                <button class="play-btn" onclick="togglePlay('audio-seed-3')">
                                    <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                                </button>
                                <div class="time-slider-container">
                                    <span class="time-display">0:00</span>
                            ...
                            <audio id="audio-seed-3" src="audio/seedvc_cross_out.wav"></audio>
                        </div>
                    </div>
            ...
            <div class="demo-section-header">
                <h3>Same-Language Timbre Pivot (English Alto 1 ➡️ English Tenor 1)</h3>
                <p>Timbre conversion within the same language showing the effect of the target speech reference.</p>
            </div>
            <div class="vc-row">
                <div class="row-header">
                    <h4>English Alto 1 ➡️ English Tenor 1</h4>
                    <span class="pill-badge">Same-Language Pivot</span>
                </div>
                <div class="card-row-grid">
                    ...
                    <div class="audio-card">
                        ...
                        <div class="player-interface">
                            <div class="custom-player">
                                <button class="play-btn" onclick="togglePlay('audio-seed-4')">
                                    <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                                </button>
                                <div class="time-slider-container">
                                    <span class="time-display">0:00</span>
                            ...
                            <audio id="audio-seed-4" src="audio/seedvc_same_source.wav"></audio>
                        </div>
                    </div>
                    ...
                    <div class="audio-card">
                        ...
                        <div class="card-title-area">
                            <h4>Target Speech Reference</h4>
                            <p>English Tenor speaking voice reference.</p>
                        </div>
                        <div class="player-interface">
                            <div class="custom-player">
                                <button class="play-btn" onclick="togglePlay('audio-seed-5')">
                                    <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                                </button>
                                <div class="time-slider-container">
                                    <span class="time-display">0:00</span>
                            ...
                            <audio id="audio-seed-5" src="audio/seedvc_same_target.wav"></audio>
                        </div>
                    </div>
                    ...
                    <div class="audio-card">
                        ...
                        <div class="card-title-area">
                            <h4>Pivoted Singing Output</h4>
                            <p>English Alto singing converted to English Tenor.</p>
                        </div>
                        <div class="player-interface">
                            <div class="custom-player">
                                <button class="play-btn" onclick="togglePlay('audio-seed-6')">
                                    <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                                </button>
                                <div class="time-slider-container">
                                    <span class="time-display">0:00</span>
                            ...
                            <audio id="audio-seed-6" src="audio/seedvc_same_out.wav"></audio>
                        </div>
                    </div>
...
def main():
    demo_dir = "docs/demos/voice_conversion"
    ...
    files_map = {
        ...
        "outputs/seedvc_pivot/gtsinger_en_alto1_to_ja_tenor1_30steps/audio/01_source_singing.wav": "seedvc_cross_source.wav",
        "outputs/seedvc_pivot/gtsinger_en_alto1_to_ja_tenor1_30steps/audio/02_target_speech_reference.wav": "seedvc_cross_target.wav",
        "outputs/seedvc_pivot/gtsinger_en_alto1_to_ja_tenor1_30steps/seedvc_raw/converted_target_singing_ref/vc_0000_0000_1.0_30_0.7.wav": "seedvc_cross_out.wav",
        
        "outputs/seedvc_pivot/gtsinger_en_alto1_to_en_tenor1_30steps/audio/01_source_singing.wav": "seedvc_same_source.wav",
        "outputs/seedvc_pivot/gtsinger_en_alto1_to_en_tenor1_30steps/audio/02_target_speech_reference.wav": "seedvc_same_target.wav",
        "outputs/seedvc_pivot/gtsinger_en_alto1_to_en_tenor1_30steps/seedvc_raw/converted_target_singing_ref/vc_0000_0000_1.0_30_0.7.wav": "seedvc_same_out.wav",
    }
    ...
    create_html(os.path.join(demo_dir, "index.html"))
    
    # Compress into a self-contained ZIP archive
    zip_path = os.path.join(demo_dir, "voice_conversion.zip")
    ...
    # Clean up old scattered legacy demo files to keep outputs pristine
    legacy_files = [
        "outputs/meeting_demo.zip",
        "outputs/meeting_demo.html",
        "docs/demos/meeting_demo/meeting_demo.zip",
        "docs/demos/meeting_demo/index.html"
    ]
